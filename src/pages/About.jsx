    ...
    <div>
      ...
      <section className="bg-blue-950 py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col gap-3">
          ...
          <h1 className="text-4xl font-bold text-white">About KIHS</h1>
      ...
      <section className="bg-slate-50 py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white border border-slate-200 rounded-lg p-8 flex flex-col gap-4">
            ...
            <p className="text-slate-500 text-base leading-relaxed">
              To train highly skilled and motivated medical professionals who
              can serve nationally and internationally, upholding medical
              standards.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-8 flex flex-col gap-4">
            ...
            <p className="text-slate-500 text-base leading-relaxed">
              To be one of the leading institutes of health sciences in Uganda,
              ensuring access to skilled health workers across the country and
              beyond.
            </p>
          </div>
        </div>
