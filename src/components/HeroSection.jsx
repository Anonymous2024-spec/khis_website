      ...
      <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-gray-300 text-base leading-relaxed max-w-xl">
            A tertiary private medical training institution preparing students
            with quality education that affords them the opportunity to achieve
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
          <div className="bg-blue-900 rounded-lg p-6 flex flex-col gap-3 border border-blue-800">
            ...
            <p className="text-gray-400 text-sm">
              Medical Laboratory Technology & Pharmacy. 3-year programs with
          ...
          <div className="bg-blue-900 rounded-lg p-6 flex flex-col gap-3 border border-blue-800">
            ...
            <p className="text-gray-400 text-sm">
              Medical Laboratory Technology & Pharmacy. 2-year programs building
              core health skills.
            </p>
            <Link
              to="/courses"
