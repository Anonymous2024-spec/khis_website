  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col gap-4 flex-1">
        {/* Category Badge */}
        <span
          className={`text-xs font-semibold px-3 py-1 rounded-full w-fit flex items-center gap-1.5 ${badgeStyle}`}
        >
          <Tag size={10} />
          {item.category}
        </span>
        ...
        {/* Title */}
        <h3 className="text-slate-900 font-bold text-base leading-snug group-hover:text-blue-700 transition-colors duration-200">
          {item.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="flex items-center gap-1 text-xs font-semibold text-blue-700 group-hover:text-amber-500 transition-colors duration-200">
