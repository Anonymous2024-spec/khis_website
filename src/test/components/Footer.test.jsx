...
describe('Footer', () => {
  it('renders the institute name', () => {
    renderFooter()
    expect(screen.getByText('Kitgum Institute of Health Sciences')).toBeInTheDocument()
  })
  ...
  it('renders the partners strip', () => {
    renderFooter()
    expect(screen.getByText('UK Funding Partner')).toBeInTheDocument()
  })
})